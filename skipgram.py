...
def entrenar_skipgram(ruta_corpus, nombre_pc, epocas=1, η=0.001, N=300, C=4, W1=None, W2=None, intervalo_guardado=50):
...
W1, W2 = entrenar_skipgram("corpus/corpus.txt", "pcmati", epocas=100, η=0.01, N=20, C=4, intervalo_guardado=50)